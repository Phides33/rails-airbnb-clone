...
rv1.save!
rv2 = Rv.new(user_id: user3.id, name: "Early century", localisation: "London", kind: "Compact", number_of_beds: 3, number_of_guests: 3, price_per_night: 20, min_stay: 4)
rv2.save!
...
rv3.save!
rv4 = Rv.new(user_id: user2.id, name: "For my Mini RV", localisation: "Tampa", kind: "Large", number_of_beds: 6, number_of_guests: 6, price_per_night: 80, min_stay: 2)
rv4.save!
rv5 = Rv.new(user_id: user2.id, name: "Escalator RV", localisation: "Nashville", kind: "Large", number_of_beds: 5, number_of_guests: 5, price_per_night: 120, min_stay: 2)
rv5.save!
rv6 = Rv.new(user_id: user3.id, name: "Jetsons RV", localisation: "Birmingham", kind: "Standard", number_of_beds: 4, number_of_guests: 4, price_per_night: 55, min_stay: 5)
rv6.save!
...
b.save!
b = Booking.new(user_id: user1.id, rv_id: rv5.id, check_in_on: "03/07/2017", check_out_on: "18/07/2017", price: 1800, status: "Accepted", rating: 5, review: "My boys just loved to run up the escalator and jump into the lake. We had a great time touring Tennessee. I strongly recommend!")
b.save!
